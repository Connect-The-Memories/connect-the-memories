const mockUsers = [
    ...
    {email: "mainuser2@gmail.com", password: "california", type: "main", media: [
      ...
      { type: "message", text: "I hope you're doing well!", uploadedBy: "supportuser1@gmail.com" },
      {type: "message", text: "We are so proud of you!", uploadedBy: "supportuser2@gmail.com"},
      {type: "message", text: "Hi Grandpa", uploadedBy: "supportuser2@gmail.com"},
      {type: "message", text: "W Gramps", uploadedBy: "supportuser2@gmail.com"},
      {type: "message", text: "Hi, how are you?", uploadedBy: "supportuser2@gmail.com"}
    ] },
